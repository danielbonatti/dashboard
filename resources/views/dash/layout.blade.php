...
<body class="pb-2">
    <div class="d-flex flex-column flex-md-row align-items-center p-3 px-md-4 mb-3 bg-white border-bottom shadow-sm">
        <a href="{{ route('home') }}" class="my-0 mr-md-auto" title="início"><img
                src="{{ asset('public/images/logo.png') }}" height="36" alt="HSist"></a>
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.success) {
                            ...
                            atualizarGraficoBar('myChart1', response.comp1, response.quan1,
                                response.quan2);
                            atualizarGraficoBar('myChart2', response.conv1, response.qtdc1,
                                response.qtdc2);
                            atualizarGraficoBar('myChart3', response.medi1, response.qtdm1,
                                response.qtdm2);
                            atualizarGraficoBar('myChart4', response.diag1, response.qtdd1,
                                response.qtdd2);
                        }
                    }
                });
